...
#(tf.multiply(tf.identity(tf.add(tf.matmul(tf.nn.sigmoid(tf.matmul(X,V1) + mu1),S1),pi1)),mapping) + tf.multiply(tf.identity(tf.add(tf.matmul(tf.nn.sigmoid(tf.add(tf.matmul(tf.nn.sigmoid(tf.matmul(X,V1) + mu1),V2),mu2)),S2),pi2)),mapping) + tf.multiply(tf.identity(tf.add(tf.matmul(tf.nn.sigmoid(tf.add(tf.matmul(tf.nn.sigmoid(tf.add(tf.matmul(tf.nn.sigmoid(tf.matmul(X,V1) + mu1),V2),mu2)),V3),mu3)),S3),pi3)),mapping))/3